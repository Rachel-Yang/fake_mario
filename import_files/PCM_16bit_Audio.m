...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid = fopen('Super_Mario_Audio_HEX.txt','r'); % specify .txt file name, W means write, r means read, case sensitive WATCH OUT!
fid2 = fopen ('Super_Mario_Audio_HEX_ROM.mif','w');
formatSpec = '%x';
