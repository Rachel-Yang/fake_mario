...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../fake_mario.sopcinfo
...
# Design Name 
# setting SOPC_NAME is fake_mario
SOPC_NAME := fake_mario
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x168
SOPC_SYSID_FLAG += --sidp=0x168
ELF_PATCH_FLAG  += --sidp 0x168

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1599639857
SOPC_SYSID_FLAG += --timestamp=1599639857
ELF_PATCH_FLAG  += --timestamp 1599639857
